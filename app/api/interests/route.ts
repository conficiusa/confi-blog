...
import { allPostsWithInterestsPrioritizedQuery } from "@/sanity/lib/queries";
...
export async function GET() {
	try {
		...
		// Fetch all posts but prioritize those matching user interests
		const posts = await sanityFetch({
			query: allPostsWithInterestsPrioritizedQuery,
